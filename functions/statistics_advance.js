            ...
            if (
              ...
              homeMatchData.forEach(match => {
                ...
                if (result === "L") {
                  ...
                  total_goals_scored += homeGoals > awayGoals ? awayGoals : homeGoals;
                  total_goals_conceeded += homeGoals > awayGoals ? homeGoals : awayGoals;
                  total_goals_scored_home += homeGoals > awayGoals ? awayGoals : homeGoals;
                  total_goals_conceeded_home += homeGoals > awayGoals ? homeGoals : awayGoals;
                } else if (result === "D") {
                  ...
                  total_goals_scored += homeGoals > awayGoals ? homeGoals : awayGoals;
                  total_goals_conceeded += homeGoals > awayGoals ? awayGoals : homeGoals;
                  total_goals_scored_home += homeGoals > awayGoals ? homeGoals : awayGoals;
                  total_goals_conceeded_home += homeGoals > awayGoals ? awayGoals : homeGoals;
                }
              });
              ...
              awayMatchData.forEach(match => {
                ...
                if (result === "L") {
                  ...
                  total_goals_scored += awayGoals > homeGoals ? homeGoals : awayGoals;
                  total_goals_conceeded += awayGoals > homeGoals ? awayGoals : homeGoals;
                  total_goals_scored_away += awayGoals > homeGoals ? homeGoals : awayGoals;
                  total_goals_conceeded_away += awayGoals > homeGoals ? awayGoals : homeGoals;
                } else if (result === "D") {
                  if (homeGoals > 0 || awayGoals > 0) {
                    count_awayMatchesTNOG++;
                    conceded_goals_away += parseInt(homeGoals);
                  ...
                  total_goals_scored += awayGoals > homeGoals ? awayGoals : homeGoals;
                  total_goals_conceeded += awayGoals > homeGoals ? homeGoals : awayGoals;
                  total_goals_scored_away += awayGoals > homeGoals ? awayGoals : homeGoals;
                  total_goals_conceeded_away += awayGoals > homeGoals ? homeGoals : awayGoals;
                }
              });
              ...
              console.log("Totals Goals Conceeded Home: ", total_goals_conceeded_home);
              console.log("Totals Goals Scored Away: ", total_goals_scored_away);
              console.log("Totals Goals Conceeded Away: ", total_goals_conceeded_away);
              if (Math.abs(conceded_goals_home - conceded_goals_away) >= 5) {
                if (count_one_zero < 2) {
                  if(total_goals_scored_home >= 9 && total_goals_conceeded_away >= 7 ){
        ...
        if (
          ...
          if (awayResults.W >= 2) {
            if (
              ...
              if (Math.abs(conceded_goals_home - conceded_goals_away) >= 5) {
                if (count_one_zero < 2) {
                  if(total_goals_scored_away >= 9 && total_goals_conceeded_away >= 7){
